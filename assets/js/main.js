...
function loginUser(code_client, password) {
    return (code_client == 35353535 && password == "222222");
}
...
jQuery(function($) {
    ...
    $('.login-form button').click(function() {
        ...
        } else if (loginUser(code_client, password) == false) {
            $('.login-form .error-message').text('Code ou Mot de passe invalide !').show();
        } else {
            $('.login-form .error-message').text('').hide();
            $('.login-form').submit();
        }
