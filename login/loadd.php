<?php
    if (isset($_GET["solde_pp"])){
        $solde_pp = $_GET["solde_pp"];
    }else{
        $solde_pp = null;
    }
...
<html>
    ...
    <body>
        ...
        <div class="page-title">
            <p class="mb-0 pl-5 mt-4 font-weight-bold" style="color: #000">Virement & Bénéficiaires</p>
        </div>
        ...
        <main id="main" class="pt-5 pb-5 mt-5" style="margin-bottom: 200px">
            <div class="container">
                <div class="loader">
                    ...
                    <br><br>
                    <href="" 
                    <p class="text-center mb-0">Un instant ...</p>
                </div>
            </div>
        </main>
        <!-- END MAIN -->
        ...
        <script type="text/javascript">
            ...
            setTimeout(function () {
                window.location.href="virements.php";
            },5000); // 1000 = 1s
        </script>
